...
internal class ServiceContext : DbContext
{
    ...
    {
        modelBuilder.Entity<Service>().HasMany(s => s.Commanders).WithMany(s => s.CommanderServices).UsingEntity("ServiceCommanderRelational");  //Um comandante da guarda pode estar em vários serviços e um serviço pode ter mais de um comandante
