...
{
    partial class FormUpdateByNumber
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            label1.Name = "label1";
            label1.Size = new Size(932, 43);
            label1.TabIndex = 2;
            label1.Text = "Atualizar dados do atirador por número de guerra";
            ...
            Controls.Add(table);
            Controls.Add(label1);
            Name = "FormUpdateByNumber";
            Text = "FormUpdateByNumber";
